...
平局！它们在设计上都非常类似，使用起来都比较容易。



## 总结

我更倾向于 `axum` 框架，因为它有最易用的 API，且它是基于 [hyper](https://crates.io/crates/hyper) 构建的，且它是 tokio 开发组的产物。

但是它是一个非常年轻的框架，这点会使很多人不敢尝试。
...
无论如何，只要拥有一个简洁的项目架构，从一个框架切换到另一个框架将会是很容易的事情，所以不要想太多，开干吧 :)
